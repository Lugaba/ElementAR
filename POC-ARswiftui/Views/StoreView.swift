...
struct StoreView: View {
    let pacotes: [PackageContent] = [PackageContent(name: "Free", imageName: "fire", price: 0, description: "Descubra os elementos a partir da água, terra, fogo e ar!", pdfName: "freeCards", isBought: true, isAvailable: true), PackageContent(name: "Elements", imageName: "water", price: 10, description: "Compre o pacote premium de 25 cartas e descubra todos os elementos do jogo", pdfName: "freeCards", isBought: false, isAvailable: true), PackageContent(name: "Animals", imageName: "water", price: 10, description: "Compre o pacote premium de 25 cartas e descubra todos os animais do jogo", pdfName: "freeCards", isBought: false, isAvailable: false), PackageContent(name: "Fantasy", imageName: "water", price: 10, description: "Compre o pacote premium de 25 cartas e descubra todos os animais do jogo", pdfName: "freeCards", isBought: false, isAvailable: false)]
